...
crManager.addCR(new CR("Nusrat Jahan Khanam", "BBA", "31", "C", "Day", "01610-167426"));
...
crManager.addCR(new CR("Tasfiya Rahman Sumaiya", "BBA", "31", "E", "Day", "01332-680158"));
...
crManager.addCR(new CR("Annyasha Das", "BBA", "32","D", "Day", ""));
...
crManager.addCR(new CR("Umme Rokeya", "BBA", "33","B", "Day", "01846-536827"));
// crManager.addCR(new CR("Jannatul Fahmida", "BBA", "33", "C", "Day", ""));
// crManager.addCR(new CR("Md Miraj Hossen Tanveer", "BBA", "33", "C", "Day", "01632-659902"));
crManager.addCR(new CR("Azadur Rahman", "BBA", "33", "C", "Day", "01310-793362"));
crManager.addCR(new CR("Dilowara Islam", "BBA", "33", "C", "Day", "01612-126981"));
...
crManager.addCR(new CR("Sinthiya Albin", "BBA", "33", "E", "Day", "01881-807010"));
crManager.addCR(new CR("Shuvro kar", "BBA", "33", "E", "Day", "01304-290556"));
...
crManager.addCR(new CR("Tamim Ahmed Chowdhury", "BBA", "34", "C", "Day", ""));
crManager.addCR(new CR("Mahmuda Sultana", "BBA", "34", "C", "Day", ""));
crManager.addCR(new CR("MD Tuhin", "BBA", "35", "A", "Day", "01814-165444"));
crManager.addCR(new CR("Ramim Sayadatun Rahman Elma", "BBA", "35", "A", "Day", "01711-669278"));
crManager.addCR(new CR("MD. Habibur Rahman", "BBA", "35", "C", "Day", "018871-59985"));
crManager.addCR(new CR("Mohammad Mahi Jawad", "BBA", "36", "A", "Day", "01845-823272"));
crManager.addCR(new CR("Faria Sultana Nowrin", "BBA", "36", "A", "Day", "01939-508097"));
crManager.addCR(new CR("Md. Amirul Islam", "BBA", "36", "A", "Day", ""));
crManager.addCR(new CR("Md. Tauhidul Islam", "BBA", "36", "B", "Day", "01568-390697"));
...
crManager.addCR(new CR("Nazim Uddin", "BFT", "36", "-", "Day", "01642-733085"));
...
crManager.addCR(new CR("Mashfiq Salam", "BTE", "33", "A", "Day", "01883-569214"));
...
crManager.addCR(new CR("Sujoy Chowdhury", "BTE", "36", "A", "Day", "01853-129924"));
crManager.addCR(new CR("Muntahika Binte Haq", "BTE", "36", "A", "Day", "01318-376907"));
...
crManager.addCR(new CR("Umme Hafsa", "CSE", "29", "B", "Day", "01616-992405"));
...
crManager.addCR(new CR("Ramish Jahra Binte Hossain", "CSE", "31", "C", "Day", "-"));
...
crManager.addCR(new CR("Md. Shahria Alam", "CSE", "34", "A", "Day", "01885-074323"));
crManager.addCR(new CR("Rimon Chowdhury", "CSE", "34", "A", "Day", "01316-532326"));
...
crManager.addCR(new CR("Fatema Akter Anna", "CSE", "36", "A", "Day", "01841-422472"));
crManager.addCR(new CR("Boktiyer Hossen", "CSE", "36", "B", "Day", "01852-294059"));
crManager.addCR(new CR("Rupali Begum Rupi", "CSE", "36", "", "Eve", ""));
...
crManager.addCR(new CR("Sanjida Azam Shuptee","CEN", "30", "", "Day", "01677-705550"));
...
crManager.addCR(new CR("Mohammad Habib Ullah","CEN", "33", "E-A", "Eve", "01644-604503"));
...
crManager.addCR(new CR("Mirza Rasib","ENG", "29", "A", "Day", "01945-796658"));
...
crManager.addCR(new CR("Shoumen Barua","ENG", "31", "B", "Day", "01568-033378"));
...
crManager.addCR(new CR("Azizul Hakim","ENG", "33", "A", "Day", "01992-676399"));
crManager.addCR(new CR("Tanjuma Akter","ENG", "33", "A", "Day", "01886-096773"));
crManager.addCR(new CR("Minhaj Uddin","ENG", "33", "B", "Day", "01619-536127"));
crManager.addCR(new CR("Sweety Das","ENG", "33", "B", "Day", ""));
...
crManager.addCR(new CR("Mohammad Raihan","EEE", "33", "A", "Eve", "01870-023939"));
