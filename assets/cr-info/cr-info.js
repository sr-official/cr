...
crManager.addCR(new CR("Md Aliph Annur","BBA", "27", "A", "Day", "01845-052776"));
...
crManager.addCR(new CR("Afraz Abdullah","BBA", "29", "-", "Day", "01944-174538"));
...
crManager.addCR(new CR("Md Shifatul Islam Santo", "BBA", "32", "A", "Day", "01516-518238"));
crManager.addCR(new CR("Afroza", "BBA", "32", "A", "Day", "-"));
crManager.addCR(new CR("Md Saydur Rahman", "BBA", "32", "B", "Day", "01875-261994"));
crManager.addCR(new CR("Sheikh Rifat Ariyan", "BBA", "32", "B", "Day", "01875-261994"));
...
crManager.addCR(new CR("Nasia Tabassum Esha", "BFT", "29", "-", "Day", "-"));
...
crManager.addCR(new CR("Mashfiq Salam Akash", "BTE", "33", "-", "-", "01883-569214"));
...
crManager.addCR(new CR("Bibi Ayesha Khatun Humaira", "CSE", "27", "A", "Day", "-"));
...
crManager.addCR(new CR("Md Sha Jahan Islam", "CSE", "32", "-", "-", "01771-137962"));
crManager.addCR(new CR("Farhana Akter", "CSE", "32", "-", "-", "-"));
crManager.addCR(new CR("Imran Hossain", "CSE", "32", "-", "-", "01674-168278"));
crManager.addCR(new CR("Muntasherul Alam", "CSE", "33", "-", "Eve", "01887-737112"));
crManager.addCR(new CR("Md Jahedul Alam", "CSE", "33", "-", "-", "01911-841155"));
crManager.addCR(new CR("Sawda Akter Sinthia", "CSE", "33", "-", "-", "-"));
...
crManager.addCR(new CR("Tajmia Jahan","ENG", "26", "-", "Day", "-"));
...
crManager.addCR(new CR("Minhaj","ENG", "33", "B", "Day", "01619-536127"));
...
crManager.addCR(new CR("Jesmin Nesa Shorna","LLB", "30", "-", "Day", "-"));
